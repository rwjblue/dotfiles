...
//[MISE] dir="{{cwd}}"
//[USAGE] flag "--dir <repo_dir>" help="Target repository path" default="."
//[USAGE] flag "--callsign <callsign>" help="Primary callsign/persona name" default="N1RWJ"
...
const repoPath = resolve(process.env.usage_dir ?? process.cwd());
const callsign = process.env.usage_callsign ?? "N1RWJ";
